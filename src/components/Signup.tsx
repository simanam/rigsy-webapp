...
export default function Signup() {
  ...
  return (
    <section id="signup" className="py-24 bg-[#161B22] relative overflow-hidden">
      {/* Background effects */}
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        {!submitted ? (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              {[
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-[#FF6B35]/10 text-[#FF6B35] flex items-center justify-center mx-auto mb-4">
                    {benefit.icon}
                  </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-xl bg-[#161B22] border border-[#21262D] text-[#F0F3F6] placeholder-[#6E7681] focus:outline-none focus:border-[#4B5EAA] transition-colors"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    required
                    className="w-full px-4 py-3 rounded-xl bg-[#161B22] border border-[#21262D] text-[#F0F3F6] focus:outline-none focus:border-[#4B5EAA] transition-colors appearance-none cursor-pointer"
                  >
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-4 bg-[#FF6B35] hover:bg-[#FF8255] text-[#0D1117] font-semibold rounded-xl transition-all transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 glow-orange"
                >
                  {loading ? (
          ...
          <div className="text-center py-12">
            <div className="w-20 h-20 rounded-full bg-[#3FB950]/20 flex items-center justify-center mx-auto mb-6">
              <svg
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#F0F3F6] mb-4">
              You&apos;re on the List!
            </h2>
